...
ln -s $dir/xbindkeys/'xbindkeysrc' '.xbindkeysrc'
ln -s '/home/athas/.config/tmux/.tmux.conf/tmux.conf' '.tmux.conf'
ln -s '/home/athas/.config/bash/.bash_profile/bash_profile' '.bash_profile'
